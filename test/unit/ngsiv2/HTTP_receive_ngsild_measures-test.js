...
describe('HTTP: NGSILD Measure reception ', function () {
    ...
    describe('When a POST multiple NGSILD entity measure with NGSILD format arrives for the HTTP binding and NGSILD is the expected payload type', function () {
        const optionsMeasure = {
            url: 'http://localhost:' + config.http.port + '/iot/json/',
            method: 'POST',
            json: [
