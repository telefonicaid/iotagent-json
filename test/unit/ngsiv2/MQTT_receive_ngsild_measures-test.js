...
describe('MQTT: NGSIv2 Measure reception ', function () {
    ...
    describe('When a publish single NGSILD append measure with NGSILD format arrives for the HTTP binding and NGSILD is the expected payload type', function () {
        const measure = {
            actionType: 'APPEND',
            entities: [
                {
    ...
    describe('When a publish multiple NGSILD append measure with NGSILD format arrives for the HTTP binding and NGSILD is the expected payload type', function () {
        const measure = {
            actionType: 'APPEND',
            entities: [
                {
