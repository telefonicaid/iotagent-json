...
describe('MQTT: Measure reception ', function () {
    ...
    describe('When a new multiple measure arrives for an unprovisioned device', function () {
        ...
        it('should send its value to the Context Broker', function (done) {
            ...
            mqttClient.publish(
                '/json/KL223HHV8732SFL1/MQTT_UNPROVISIONED/attrs',
    ...
    describe('When a new multiple measure arrives to the MQTT Topic with unknown attributes', function () {
        beforeEach(function () {
            contextBrokerMock
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext', utils.readExampleFile('./test/contextRequests/unknownMeasures2.json'))
    ...
    describe('When a new multiple measure arrives with a timestamp to the MQTT Topic', function () {
        beforeEach(function () {
            contextBrokerMock
                .matchHeader('fiware-service', 'smartGondor')
                .matchHeader('fiware-servicepath', '/gardens')
                .post('/v1/updateContext', utils.readExampleFile('./test/contextRequests/timestampMeasure2.json'))
