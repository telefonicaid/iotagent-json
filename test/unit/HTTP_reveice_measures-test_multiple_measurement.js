...
describe('HTTP: Measure reception ', function() {
    ...
    describe('When a POST measure arrives for the HTTP binding_4_multiple_measurements', function() {
        var optionsMeasure = {
        ...
        it('should return a 200 OK with no error', function() {
        ...
        it('should send its value to the Context Broker', function() {
            request(optionsMeasure, function(error, result, body) {
