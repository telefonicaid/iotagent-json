...
const testCases = [
    ...
    {
        describeName: '0020 - Simple group with attributes',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    // JEXL TESTS
    {
        describeName: '0030 - Simple group with attribute + JEXL expression boolean (!)',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0040 - Simple group with attribute + JEXL expression numeric (+3)',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0050 - Simple group with attribute + JEXL expression numeric (*3)',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0060 - Simple group with attribute + JEXL expression text (a|substr(0,2))',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0070 - Simple group with attribute + chained JEXL expression text (a|substr(0,2))',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0080 - Simple group with attribute + JEXL expression text reusing previous values)',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0090 - Simple group with attribute + JEXL expression referencing static attributes',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0100 - Simple group with attribute + JEXL expression referencing context attributes',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0110 - Simple group with attributes + JEXL multiples expressions at same time',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    // TIMESTAMP TESTS
    {
        describeName: '0150 - Simple group with attribute + timestamp:false',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0160 - Simple group with attribute + timestamp:true',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
    ...
    {
        describeName: '0010 - Provision de grupo sin atributos',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
        ...
        should: [
            {
                shouldName: 'A - Enviar su valor al Context Broker cuando se usa HTTP',
                type: 'single',
                measure: {
                    url: 'http://localhost:' + config.http.port + '/iot/json',
                    method: 'POST',
    ...
    {
        describeName: 'Basic group provision with attributes and multientity',
        provision: {
            url: 'http://localhost:' + config.iota.server.port + '/iot/services',
            method: 'POST',
            json: {
        ...
        should: [
            ...
            {
                shouldName: 'should send its value to the Context Broker with multimeasures',
                type: 'multientity',
                measure: {
                    url: 'http://localhost:' + config.http.port + '/iot/json',
                    method: 'POST',
