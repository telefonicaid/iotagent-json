...
function parseMessage(message) {
    ...
    try {
        ...
        config.getLogger().debug(context, 'stringMessage: [%s]', stringMessage);
        messageArray = [];
        ...
        try {
            stringMessage = message.toString('hex');
            config.getLogger().debug(context, 'stringMessage hex: [%s]', stringMessage);
