...
function generateCommandExecution(apiKey, device, attribute) {
    ...
    config.getLogger().debug('Sending command execution to device [%s] with apikey [%s] and payload [%s] ',
...
function commandHandler(id, type, service, subservice, attributes, callback) {
    config.getLogger().debug('Handling MQTT command for device [%s] in service [%s - %s]', id, service, subservice);
