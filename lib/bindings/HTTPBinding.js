...
function handleIncomingMeasure(req, res, next) {
    ...
    extractDevice(req.apiKey, req.deviceId, processDeviceMeasure);
}
...
function sendConfigurationToDevice(apiKey, deviceId, results, callback) {
    ...
    extractDevice(apiKey, deviceId, function(error, device) {
        if (error) {
            callback(error);
...
function handleConfigurationRequest(req, res, next) {
    ...
    extractDevice(req.apiKey, req.deviceId, function(error, device) {
       if (error) {
           next(error);
       } else {
