...
function checkMandatoryParams(queryPayload) {
    return function (req, res, next) {
        ...
        req.attr = req.query.attr; // optional
...
function start(callback) {
    ...
    // BodyParser text is needed
    httpBindingServer.router.post(
        constants.HTTP_MEASURE_TEXT_PATH,
        bodyParser.text(),
        checkMandatoryParams(false),
        parseData, // non multiple measures are expected in this case
        addTimestamp,
        handleIncomingMeasure,
        returnCommands
    );
    ...
    // BodyParser raw
    httpBindingServer.router.post(
        constants.HTTP_MEASURE_RAW_PATH,
        bodyParser.raw(),
        checkMandatoryParams(false),
        parseData, // non multiple measures are expected in this case
        addTimestamp,
