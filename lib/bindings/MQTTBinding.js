...
function start(callback) {
    ...
    const options = {
        ...
        subscribeBatchSize: mqttConfig.subscribeBatchSize ? parseInt(mqttConfig.subscribeBatchSize) : null
    };
    ...
    function createConnection(callback) {
        ...
        if (!mqttClient) {
            ...
            return callback('error mqttClient not created'); // allow continue
        }
